...
def main():
  try:
    ...
    for _ in range(100):  # ADDING LOTS OF RANDOM CASES
      r = random.randint(MINR[test_nb], MAXR[test_nb])
      x = random.randint(-MAXX+r, MAXX-r)
      y = random.randint(-MAXX+r, MAXX-r)
      CASES[test_nb].append(((x,y), r))
    minr, maxr, cases = (MINR[test_nb], MAXR[test_nb], CASES[test_nb])
  except:

...
# An le groupe alterne (permutations de signature 1)
# est engendre par les 3-cycles
# La question est de savoir si la permutation donnee en
# entree est generee par des 3-cycles, donc si elle est
# de signature 1
...
def main():
    ...
    for _ in xrange(T):
        ...
        print 'YES' if inversions(A)%2==0 else 'NO'
